...
<div class="w3-top">
  <ul class="w3-navbar w1-white w3-wide w3-padding-4 w3-card-2">
    ...
    <li class="w3-right w3-hide-small">
      ...
      <a href="#ING" class="w3-left">ING</a>
      <a href="#Q&A" class="w3-left w3-margin-right">Q&A</a>
    </li>
  </ul>
</div>
<div class="w3-content w3-padding" style="max-width:1564px">
  ...
  <div class="w3-container w3-padding-32" id="Today Start">
    <h3 class="w3-border-bottom w3-border-light-grey w3-padding-12">Today Start</h3>
  </div>
